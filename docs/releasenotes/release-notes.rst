...
|            |          |             | Paris Release                        |
+------------+----------+-------------+--------------------------------------+
| 2025-11-11 | 2.2.0    | Dan Timoney | Release version,                     |
|            |          |             | Quebec Release                       |
+------------+----------+-------------+--------------------------------------+
| 2026-07-14 | 2.3.1    | John Keeney | Release version,                     |
|            |          |             | Rabat Release                        |
+------------+----------+-------------+--------------------------------------+
...
Quebec, Release 2.2.0
---------------------
+-----------------------------+-----------------------------------------------------+
| **Project**                 | CCSDK ORAN                                          |
|                             |                                                     |
+-----------------------------+-----------------------------------------------------+
| **Repo/commit-ID**          | ccsdk-oran/53b0680a3dab0ed097f46155245364db0f85c8a4 |
|                             |                                                     |
+-----------------------------+-----------------------------------------------------+
| **Release designation**     | Quebec                                              |
|                             |                                                     |
+-----------------------------+-----------------------------------------------------+
| **Release date**            | 2025-11-11                                          |
|                             |                                                     |
+-----------------------------+-----------------------------------------------------+
| **Purpose of the delivery** | Quebec - Release, 2.2.0 version                     |
|                             |                                                     |
+-----------------------------+-----------------------------------------------------+
...
|                             |                                                     |
+-----------------------------+-----------------------------------------------------+
| **Repo/commit-ID**          | ccsdk-oran/2f746a9eb7adb33e51438209bed402444b8694f4 |
|                             |                                                     |
+-----------------------------+-----------------------------------------------------+
| **Release designation**     | Rabat                                               |
|                             |                                                     |
+-----------------------------+-----------------------------------------------------+
| **Release date**            | 2026-07-14                                          |
|                             |                                                     |
+-----------------------------+-----------------------------------------------------+
| **Purpose of the delivery** | Rabat - Release, 2.3.1 version                      |
|                             |                                                     |
+-----------------------------+-----------------------------------------------------+
