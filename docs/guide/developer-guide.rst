 ...
 * A1 Policy configuration. This includes:
   ...
   * Query functions to check the status of each near-RT RIC, and thier A1 Policy Instances. 
...
The A1 Policy Management Service uses the default security keystore and truststore that are included the built container. The paths and
