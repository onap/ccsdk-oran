...
class RicSynchronizationTaskTest {
    ...
    void ricIdleAndErrorDeletingPoliciesAllTheTime_thenSynchronizationWithFailedRecovery() {
        ...
        when(a1ClientMock.deleteUnknownPolicies(anySet())).thenReturn(Flux.error(exception));
    ...
    void ricIdleAndHavePolicies_thenSynchronizationWithRecreationOfPolicies() {
        ...
        when(a1ClientMock.deleteUnknownPolicies(anySet())).thenReturn(Flux.just("OK"));
        ...
        verify(a1ClientMock).deleteUnknownPolicies(anySet());
    ...
    private void setUpCreationOfA1Client() {
        ...
        doReturn(Flux.empty()).when(a1ClientMock).deleteUnknownPolicies(anySet());
    }
