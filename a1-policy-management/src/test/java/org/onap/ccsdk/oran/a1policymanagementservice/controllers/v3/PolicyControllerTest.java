...
public class PolicyControllerTest {
    ...
    void testDeletePolicy() throws Exception {
        ...
        String policyBody = testHelper.postPolicyBody(nonRtRicId, policyTypeName);
        Mono<ResponseEntity<String>> responseMono = testHelper.restClientV3().postForEntity(url, policyBody);
        PolicyObjectInformation policyObjectInformation = gson.fromJson(responseMono.block().getBody(), PolicyObjectInformation.class);
        Mono<ResponseEntity<String>> responseMonoDelete = testHelper.restClientV3().deleteForEntity(url+"/"+policyObjectInformation.getPolicyId());
