...
class PolicyControllerV3Test {
    ...
    void init() {
        ...
        this.applicationConfig.setValidateSchema(ApplicationConfig.ValidateSchema.NONE);
    }
    ...
    void testPolicyTypeSchemaValidationFail() throws Exception {
        this.applicationConfig.setValidateSchema(ApplicationConfig.ValidateSchema.FAIL);
        String nonRtRicId = "ric.1";
        String policyTypeName = "type1_1.2.3";
        String url = "/policies";
        testHelperTest.addPolicyType(policyTypeName, nonRtRicId);
    ...
    void testPolicyTypeSchemaValidationInfo() throws Exception {
        this.applicationConfig.setValidateSchema(ApplicationConfig.ValidateSchema.INFO);
        String nonRtRicId = "ric.1";
        String policyTypeName = "type1_1.2.3";
        String url = "/policies";
        testHelperTest.addPolicyType(policyTypeName, nonRtRicId);
    ...
    void testPolicyTypeSchemaValidationWarn() throws Exception {
        this.applicationConfig.setValidateSchema(ApplicationConfig.ValidateSchema.WARN);
        String nonRtRicId = "ric.1";
        String policyTypeName = "type1_1.2.3";
        String url = "/policies";
        testHelperTest.addPolicyType(policyTypeName, nonRtRicId);
