...
public class ServiceController {
    ...
    @ApiResponses(
        value = { //
            ...
            @ApiResponse(code = 404, message = "Service is not found", response = ErrorResponse.Problem.class)})
    ...
    @ApiResponses(
        value = { //
            ...
            @ApiResponse(code = 404, message = "Service not found", response = ErrorResponse.Problem.class)})
