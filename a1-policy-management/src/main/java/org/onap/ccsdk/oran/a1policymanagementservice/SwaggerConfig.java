...
public class SwaggerConfig extends WebMvcConfigurationSupport {
    ...
    static final String DESCRIPTION = //
        "The O-RAN NonRT-RIC Policy Management Service provides a REST API for management of A1 policices. \n" //
            + "It provides support for:" //
            + "<ul>" //
            + "<li>A1 Policy creation and modification.</li>" //
            + "<li>Maintaining a view of supported NearRT-RIC policy types </li>" //
            + "<li>Supervision of using services (R-APPs). When a service is unavailble, its policies are removed. </li> " //
            + "<li>Monitoring and maintaining consistency of the SMO view of A1 policies and the NearRT-RICs </li>" //
            + "</ul>"//
    ;
