...
public class PolicyController {
    ...
    public ResponseEntity<Object> getPolicyInstances( //
            ...
            @RequestParam(name = Consts.SERVICE_ID_PARAM, required = false) String service) throws EntityNotFoundException //
    {
    ...
    public ResponseEntity<Object> getPolicyIds( //
            ...
            @ApiParam(name = Consts.SERVICE_ID_PARAM, required = false,
                    value = "The identity of the service to get policies for.") //
            @RequestParam(name = Consts.SERVICE_ID_PARAM, required = false) String serviceId) throws EntityNotFoundException //
    {
