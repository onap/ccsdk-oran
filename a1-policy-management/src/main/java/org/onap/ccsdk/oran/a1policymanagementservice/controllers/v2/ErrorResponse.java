...
class ErrorResponse {
    ...
    @ApiModel(value = "Problem", description = "Problem as defined in https://tools.ietf.org/html/rfc7807")
    public static class Problem {
        ...
        public Problem(String detail, Integer status) {
            this.detail = detail;
            this.status = status;
        }
    ...
    static ResponseEntity<Object> create(String text, HttpStatus code) {
        Problem p = new Problem(text, code.value());
