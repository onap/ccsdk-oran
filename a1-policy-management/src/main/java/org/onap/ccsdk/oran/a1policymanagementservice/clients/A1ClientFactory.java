    ...
    private A1Client createCustomAdapter(Ric ric) throws ServiceException {
        try {
            ...
            if (A1Client.class.isAssignableFrom(clazz)) {
                ...
                logger.debug("A1Client ("+clazz.getTypeName()+") being created for ric: {}", ric.getConfig().getRicId());
                ...
                logger.debug("A1Client ("+clazz.getTypeName()+") factory creating client for ric: {}", ric.getConfig().getRicId());
